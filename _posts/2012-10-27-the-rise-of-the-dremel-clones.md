...
tags: ["Apache", "big data", "Cloudera", "dremel", "drill", "druid", "Google", "hadoop", "impala", "mapreduce", "open source", "real-time analytics"]
author: "melmeric"
permalink: /2012/10/27/the-rise-of-the-dremel-clones/
---

It looks like people are now realizing the need for powerful real-time analytics engines. [Dremel](http://research.google.com/pubs/pub36632.html) was designed by Google as an interactive query engine for cluster environments. Dremel is a scalable, interactive ad-hoc query system for analysis of read-only nested data. It's the perfect tool to power your Big Data dashboards. Now a bunch of open source clones are appearing. Will they have the same luck as Hadoop?

Here the contenders:

	
- The regular: [Apache Drill](http://incubator.apache.org/drill/)
