...
sitemap: false
wp_id: 570
wp_slug: "bsp-with-hadoop-and-without"
permalink_slug: "bsp-with-hadoop-and-without"
wp_url: "https://gdfm.me/2011/11/19/bsp-with-hadoop-and-without/"
---

I have recently started to look at the [BSP (Bulk Synchronous Parallel)](http://en.wikipedia.org/wiki/Bulk_Synchronous_Parallel "BSP") model of computation for large scale graph analysis.
...
**The good:**Very active community with people from the Hadoop ecosystem.
Runs directly on Hadoop.
**The bad:**Early stage.Hadoop leaks in the API.
...
**The good:**Commercial support.
**The bad:**Early stage, not yet in Incubator.
API has rough edges.
Requires additional infrastructure.
